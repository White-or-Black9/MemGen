"""MAB-5C: detective_qa decoupled retrieval-update thresholds on 10 contexts."""
...
EXPERIMENT_NAME = "MAB-5C: detective_qa Decoupled Retrieval-Update Thresholds n10"
RUN_PREFIX = "detectiveqa-decoupled-thresholds-n10"
...
DEFAULT_OUTPUT_ROOT = "outputs/mab/decoupled_thresholds_detectiveqa_n10"
...
def _build_research_note(
    *,
    ...
    note_path = Path("research_notes/benchmarks/memoryagentbench_mab5c_decoupled_thresholds.md")
                    ...
                    run_config.update(
                        {
                            "retrieve_threshold": DEFAULT_RETRIEVE_THRESHOLD,
                            "update_threshold": DEFAULT_UPDATE_THRESHOLD,
                            "mechanism": "decoupled_retrieval_update_thresholds",
                        }
                    )
